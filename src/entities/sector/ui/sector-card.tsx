  ...
  return (
    <div className="group rounded-2xl bg-[#0D1316] border border-white/[0.08] hover:border-white/20 p-6 flex flex-col justify-between transition-all duration-200 hover:-translate-y-1 hover:shadow-xl hover:shadow-black/60">
      ...
      <div className="mt-6 pt-4 border-t border-white/[0.06]">
        <a
          href="#demo"
          className="flex items-center justify-between w-full px-3.5 py-2 rounded-lg bg-[#12191D] hover:bg-[#1A2429] text-[#E6F1F0] hover:text-white border border-white/10 hover:border-white/20 text-xs font-medium transition-colors"
        >
